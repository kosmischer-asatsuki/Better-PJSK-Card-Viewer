...
export const UI_COPY = {
  zh: {
    ...
    heroTitle: "卡面档案室",
    heroDescription: "收藏每一个闪耀瞬间。浏览 26 名角色的完整卡面，为心动之作留下你的星级。",
  ...
  ja: {
    ...
    heroTitle: "カードアーカイブ",
    heroDescription: "輝く一瞬を集めよう。26人のカードを眺め、お気に入りに星を残せます。",
  ...
  en: {
    ...
    heroDescription: "Collect every shining moment. Browse cards from all 26 characters and rate your favorites.",
